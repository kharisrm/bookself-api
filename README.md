...
berikut penjelasan dari code yang saya buat 
module.exports = books;
// // Mengimpor pustaka nanoid untuk menghasilkan ID unik untuk buku
// const nanoid = require("nanoid");

// // Mengimpor array 'books' dari modul terpisah
// const books = require("./books");

// // Handler untuk menambahkan buku baru ke dalam daftar
// const addBookHandler = (request, h) => {
//   // Ekstrak data yang diperlukan dari payload permintaan
//   const { name, year, author, summary, publisher, pageCount, readPage, reading } = request.payload;

//   // Validasi untuk memeriksa apakah nama buku telah disediakan
//   if (!name) {
//     // Jika nama buku tidak diberikan, kembalikan respons dengan status fail
//     const response = h.response({
//       status: "fail",
//       message: "Gagal menambahkan buku. Mohon isi nama buku",
//     });
//     response.code(400); // Kode status HTTP 400 Bad Request
//     return response;
//   }

//   // Validasi untuk memeriksa apakah readPage lebih besar dari pageCount
//   if (readPage > pageCount) {
//     // Jika readPage lebih besar dari pageCount, kembalikan respons dengan status fail
//     const response = h.response({
//       status: "fail",
//       message: "Gagal menambahkan buku. readPage tidak boleh lebih besar dari pageCount",
//     });
...
//   // Membuat ID unik menggunakan fungsi nanoid
//   const id = nanoid();
...
//   if (isSuccess) {
//     // Jika berhasil ditambahkan, kembalikan respons dengan status success
//     const response = h.response({
//       status: "success",
//       message: "Buku berhasil ditambahkan",
//       data: {
...
//       },
//     });
//     response.code(201); // Kode status HTTP 201 Created
//     return response;
//   }

//   // Jika gagal ditambahkan, kembalikan respons dengan status error
//   const response = h.response({
//     status: "error",
//     message: "Buku gagal ditambahkan",
//   });
//   response.code(500); // Kode status HTTP 500 Internal Server Error
//   return response;
// };
